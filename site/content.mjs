...
export const profile = {
  ...
  introduction: 'I build AI systems for real-world complexity.',
  description: 'My work spans healthcare, operations, and research. I’m interested in making systems more useful by helping them understand the context they’re missing.',
...
export const projects = [
 {slug:'diatrend',title:'Diatrend',description:'AI-driven CGM trajectory prediction — PyTorch, TabTransformer/GNN, FastAPI.',repo:'https://github.com/iamrishabruh/Diatrend-ML',category:'Healthcare · Machine learning',focus:'Exploring how glucose trajectories can be modeled from continuous glucose monitoring data.',status:'Research project; not a clinically validated system.'},
 {slug:'nexus-lite',title:'Nexus Lite',description:'Cross-platform mobile health tracker — React Native Expo + FastAPI.',repo:'https://github.com/iamrishabruh/Nexus-Lite',category:'Mobile · Healthcare',focus:'A cross-platform interface for bringing health-tracking information together.',status:'Project retained from the original portfolio. The repository link was unavailable during the audit.',unavailable:true},
